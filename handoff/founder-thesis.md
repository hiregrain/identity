...
Recorded 2026-08-16, from the founder, near-verbatim. Self-assessed
confidence: high. Entries translated into Dispatch decisions the same day: 43
(stretch selections), 44 (responsibility dimensions), 45 (commodity-work
filter), 46 (substrate line).
...
Both global and American labor, for different scarcity. Global
emerging-market talent gives scale, inexpensive discovery, and operational
capacity; American/local talent matters where physical presence, licenses,
institutional access, customer trust, or accountability matter. The ultimate
search is geography-agnostic: find exceptional operators wherever they are.
...
4. **Human control of autonomous systems** — not generic labeling/eval labor;
   ...
   escalation owner → workflow controller → human/agent team manager →
   process owner → GM. As AI improves, fewer humans oversee vastly more
   machine output.
...
Many feeder pools → a few owned proving grounds → one common operator ladder.
Not everyone's entire career is owned: some programs train and place people
externally; others keep people inside managed operations long enough to
observe them under increasing responsibility. The best performers can later
be given teams, customers, budgets, P&Ls, and ultimately businesses.

## Long-term hedge against AGI
...
Not "build a giant workforce." Build the universal talent infrastructure
once, then attach it first to physical-infrastructure training, owned
deployment operations, and high-accountability managed operations where both
the work and the resulting capability signal should remain valuable across a
very wide range of AI outcomes.

## Relation to Dispatch (recorder's note, not the founder's text)
...
deliberately deferred, entry 28 family, with entry 41's per-project QA
budgets as its thin edge.
