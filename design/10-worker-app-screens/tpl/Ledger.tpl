    ...
    const GROUPS = [
      ...
      {month:'August 2026', rows:[
        ...
        {day:'4 Aug',  what:'You granted Alorica Philippines your whole record',
         who:'Sent to ramil.antonio@alorica.com, confirmed the same day'},
        {day:'9 Aug',  what:'Teleperformance Philippines read your record',
         who:'Grant issued 19 Jul 2026, ends 17 Aug 2026'},
        {day:'12 Aug', what:'Alorica Philippines read your record',
         who:'Grant issued 4 Aug 2026, ends 2 Sep 2026'}
      ]}
    ];
