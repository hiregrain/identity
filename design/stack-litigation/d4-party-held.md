...
6. **Hybrid position:** party-held default; a bootstrap tier of
   *ledger-provisioned, partner-owned* KMS (custody transferred at
   ...
   hosted — different trust class, different stakes.
...
- **The litigated dispute.** Research `06` §5 predicates the record's
  ...
  FCRA-shaped disputes. In any dispute that reaches counsel — a worker
  suing over a career-damaging attestation, a party disavowing one — the
  first discovery question is "who could have produced this signature?"
...
- **T3 — Counsel concludes the category argument is legally inert:** a
  ...
  distinguish custody models. (This would refute §1.2, not §1.1 — the
