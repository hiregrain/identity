...
document. Open items are marked open.

## Brand

- **Grain is the brand we build around.** It is both the infrastructure
  name and the consumer-facing brand.
- The hospitality product (hiregrain.com) will become a distinct product
  line on top of this infrastructure, but **none of its existing design
  is incorporated**. This identity is built from first principles.
- The food connotation of "grain" is acknowledged and deliberately not a
  constraint.
...
- Worker opening their ledger, target feeling: **passport + vault +
  trophy case**. State-grade and portable; secure and serious; earned
  and proud.
...
Light:
- Applying to a job.
- Adding (unverified) work history.

Also in scope: a disclosure grant being exercised.

Audio: not required. Do not force it.

## Form factor

- **Mobile-first**, with full web compatibility required.
...
- **Typography** (serif vs. sans instinct: unknown).
- **Skeuomorphism**: cautious. Material references can read cheap or
  vibe-coded. Working hypothesis to test in research: structural
  borrowing (precision linework, stamp-like verification, ledger row
  discipline) may work where textural borrowing (wood photos, paper
  overlays) fails.
